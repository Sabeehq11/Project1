...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const employmentHistory = [
         { id: 1, title: 'AWS Intern', company: 'Hillcrestech', years: 'September 2024 - present', description: '50 hours of hands of hands on training with AWS, ' },
         { id: 2, title: 'Inventory/Accounting Intern', company: 'Archon Inc', years: 'May 2024 - August 2024', description: 'Excel-tracked inventory for accurate accounting.' },
         { id: 3, title: 'Teacher', company: 'BCIC', years: 'November 2021 - January 2022', description: 'Instructed children aged 5-15 every Sunday to enhance their understanding of Islamic principles and teachings.' }
